...
async function linkEvidence(
  ...
  for (const evidenceId of evidenceIds) {
    await db
      ...
      .onConflictDoNothing({
        target: [
          trendbriefOpportunityEvidence.opportunityId,
          trendbriefOpportunityEvidence.evidenceId,
        ],
      });
  }
}

async function listEvidenceForOpportunity(
  opportunityId: string,
...
export const TrendbriefOpportunityEvidenceRepository = {
  linkEvidence,
